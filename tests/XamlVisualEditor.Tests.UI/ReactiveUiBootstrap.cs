...
/// <summary>
/// ReactiveUI 23 no longer initializes itself on first use; the headless test
/// application does not run UseReactiveUI, so the module initializer performs
/// the equivalent setup once per test assembly.
/// </summary>
