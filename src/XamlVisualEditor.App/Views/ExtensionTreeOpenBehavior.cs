...
public sealed class ExtensionTreeOpenBehavior
{
    ...
    private static void OnPointerPressed(object? sender, PointerPressedEventArgs e)
    {
        ...
        _ = GetNodeFromEvent(dataGrid, e);
        if (dataGrid.DataContext is ExtensionTreeViewModel viewModel)
        {
            ICommand openCommand = viewModel.OpenSelectedCommand;
    ...
    private static ExtensionTreeNodeViewModel? GetNodeFromEvent(DataGrid dataGrid, PointerPressedEventArgs e)
    {
    ...
    private static ExtensionTreeNodeViewModel? ResolveNode(object? dataContext)
    {
