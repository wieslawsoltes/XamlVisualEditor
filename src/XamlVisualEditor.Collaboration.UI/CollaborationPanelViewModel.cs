...
/// </summary>
public sealed partial class ParticipantViewModel : ReactiveObject
{
    /// <summary>
    ...
    /// </summary>
    [Reactive]
    public partial string Color { get; set; } = "#0078D4";
    ...
    /// </summary>
    [Reactive]
    public partial int CaretLine { get; set; }

    /// <summary>
    /// Gets or sets the participant's caret column.
    /// </summary>
    [Reactive]
    public partial int CaretColumn { get; set; }
...
/// </summary>
public sealed partial class CollaborationPanelViewModel : ReactiveObject, IDisposable, ICollaborationPanelModel
{
    ...
    /// </summary>
    [Reactive]
    public partial string LocalUserName { get; set; } = Environment.UserName;
    ...
    /// </summary>
    [Reactive]
    public partial string StatusMessage { get; set; } = "Not connected";
